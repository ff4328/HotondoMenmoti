...
class MiniMushroomManager : public EnemyManagerBase
{
	...
	static constexpr int kMaxMiniMushroomNum = 1000;

	static constexpr int kStatusMiniMushroomNum = 20;

public:

	MiniMushroomManager();

	~MiniMushroomManager() = default;
...
private:
	...
	/// 敵のグラフィックハンドル
	/// </summary>
	int m_graphHandle[kMiniMushroomMotionNum][kStatusMiniMushroomNum];
